...
const Article = () => {
    ...
    return (
        <ScrollView>
            <Image
                source={{ uri: "https://ce.ittelkom-sby.ac.id/wp-content/uploads/2020/09/WhatsApp-Image-2018-04-18-at-11.47.40-AM-1024x564-1.png",}} style={styles.logo}/>
            ...
            <View style={styles.content}>
                <Image source={{ uri: "https://ittelkom-sby.ac.id/wp-content/uploads/2022/10/asdfghkl-768x472.jpg",}} style={styles.mainImage}/>
                <Separator height={10}/>
                <Text>
                ...
                <Separator height={20}/>
                <Button text="Show Modal" onPress={showModal} />
                <Separator height={70}/>
            </View>
            <Modal
                animationType="slide"
